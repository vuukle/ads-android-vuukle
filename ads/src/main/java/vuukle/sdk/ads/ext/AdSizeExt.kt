...
import vuukle.sdk.ads.exception.VuukleAdsConfigurationNotFound
import vuukle.sdk.ads.model.VuukleAdSize

fun VuukleAdSize.Type.toAdSize(
    width: Int? = null,
    height: Int? = null
): AdSize {
    return when (this) {
        ...
        VuukleAdSize.Type.FLUID -> {
            return try {
                ...
                throw VuukleAdsConfigurationNotFound(
                    "If AdSize is FLUID, please width and height is required"
                )
            }
        }
    }
